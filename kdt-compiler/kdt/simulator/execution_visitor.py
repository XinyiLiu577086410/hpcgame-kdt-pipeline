...
class ExecutionVisitor(AutoRecursiveIRVisitor):
    ...
    def visit_SelectionExpr(self, node: SelectionExpr) -> Any:
    ...
    def visit_Print(self, node: Print):
        ...
        if isinstance(node.tile_or_expr, Tile):
            ...
            value = node.tile_or_expr.accept(self)
            print(f"[Job {self.context.job_id}] {node.msg}: {value}")
